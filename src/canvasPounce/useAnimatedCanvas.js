...
export function useAnimatedCanvas(pounceState, animationStep, pounceKeyHandler, canvasWidth, canvasHeight) {
  let ref = useRef();
  let key = '0';
  ...
  let pounceKeyProgram = typeof pounceKeyHandler === 'string' ? parse(pounceKeyHandler) : pounceKeyHandler;
  useEffect(() => {
